...
public class userControllers {
    ...
    public GetAllResponse<UsersDTO> getAllUsers(@RequestParam (value="PageSize" , defaultValue = "10", required = false) Integer PageSize,@RequestParam (value="PageNumber" , defaultValue = "0", required = false) Integer PageNumber) {
    ...
    public ResponseEntity<?> createUsers(@Valid @RequestBody UsersDTO users) {
        ...
        return this.userservices.createUsers(users);
    }
